...
-- i[0]	=>  Location: PIN_C6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i[1]	=>  Location: PIN_B6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \z~0_combout\ = (\s~input_o\ & ((\i[1]~input_o\) # (\i[0]~input_o\)))
