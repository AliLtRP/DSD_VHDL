        ...
        begin: pcs_ch
                alt_10gbaser_pcs #(
                    ...
                    .latadj_width           (latadj_width)
                        ...
                        .tx_latency_adj(tx_latency_adj[(i + 1) * latadj_width -1 : i * latadj_width]),
                        .rx_latency_adj(rx_latency_adj[(i + 1) * latadj_width -1 : i * latadj_width])
                        );
...
// one pma support n channel
   alt_pma_10gbaser_tgx #(
        ...
        .pll_type ((pll_type == "ATX")? "High speed ATX" : "CMU"),//ATX|CMU
        .bonded_mode ("FALSE"),
