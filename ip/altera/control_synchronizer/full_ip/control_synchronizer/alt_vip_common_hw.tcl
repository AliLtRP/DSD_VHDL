...
proc add_common_pack_files {} {
	add_file src_hdl/alt_vipcts131_common_package.vhd {SYNTHESIS SIMULATION}
}

proc add_avalon_mm_bursting_master_component_files {} {
	add_file src_hdl/alt_vipcts131_common_avalon_mm_bursting_master_fifo.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_avalon_mm_master.v {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_unpack_data.v {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_pulling_width_adapter.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_general_fifo.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_fifo_usedw_calculator.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_gray_clock_crosser.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_std_logic_vector_delay.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_one_bit_delay.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_logic_fifo.vhd {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_common_ram_fifo.vhd {SYNTHESIS SIMULATION}
}

proc add_avalon_st_input_component_files {} {
	add_file src_hdl/alt_vipcts131_common_stream_input.v {SYNTHESIS SIMULATION}
}

proc add_avalon_st_output_component_files {} {
	add_file src_hdl/alt_vipcts131_common_stream_output.v {SYNTHESIS SIMULATION}
}

proc add_avalon_mm_slave_component_files {} {
	add_file src_hdl/alt_vipcts131_common_avalon_mm_slave.v {SYNTHESIS SIMULATION}
}

proc add_prc_component_files {} {
	add_file src_hdl/alt_vipcts131_prc.v {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_prc_core.v {SYNTHESIS SIMULATION}
	add_file src_hdl/alt_vipcts131_prc_read_master.v {SYNTHESIS SIMULATION}
