...
#
# $Header: //acds/rel/13.1/ip/altera_pcie_pipe/cv/cv_xcvr_pipe_common.tcl#1 $
...
# |
proc pipe_decl_fileset_groups_cv_xcvr_pipe_native { phy_root } {
	...
	alt_xcvr_csr_decl_fileset_groups $phy_root/../../altera_xcvr_generic
		...
		cv_xcvr_emsip_adapter.sv
		cv_xcvr_pipe_native_hip.sv
	} {C5}

}

proc pipe_decl_fileset_groups_cv_xcvr_pipe_nr { phy_root } {

	pipe_decl_fileset_groups_cv_xcvr_pipe_native $phy_root
}

proc pipe_decl_fileset_groups_top { phy_root } {

	pipe_decl_fileset_groups_cv_xcvr_pipe_nr $phy_root
}
