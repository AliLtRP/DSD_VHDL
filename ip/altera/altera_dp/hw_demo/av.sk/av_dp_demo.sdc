...
# xcvr_pll_refclk is actually 125 MHz on the AV starter kit
create_clock -name {xcvr_pll_refclk} -period 8.000 -waveform { 0.000 4.000 } [get_ports {xcvr_pll_refclk}]
