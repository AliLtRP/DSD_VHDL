...
# Initialization MRS commands, which include:
#  1) two or more dummy MRS
#  2) a valid MRS command that turns off DLL to reset it
#  3) wait MRSC
#  4) a valid MRS command that turns on DLL
LABEL MRS_INIT rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_mrs_dummy | do_0 | dm_0 # ** Dummy MRS
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_mrs_dummy | do_0 | dm_0 # ** Dummy MRS
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_mrs_calib_dll_off | do_0 | dm_0 # ** Valid MRS with DLL set to off
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_mrs_calib_dll_on | do_0 | dm_0 # ** Valid MRS with DLL set to on
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
...
LABEL MRS rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_mrs | do_0 | dm_0 # ** MRS
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # NOP
...
LABEL REF_X8 rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_0 | do_0 | dm_0 # ** REF 0
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_1 | do_0 | dm_0 # ** REF 1
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_2 | do_0 | dm_0 # ** REF 2
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_3 | do_0 | dm_0 # ** REF 3
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_4 | do_0 | dm_0 # ** REF 4
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_5 | do_0 | dm_0 # ** REF 5
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_6 | do_0 | dm_0 # ** REF 6
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_ref_7 | do_0 | dm_0 # ** REF 7
LABEL __NL rff_0 | cmd_ret | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # return
...
LABEL __NL rff_0 | cmd_wdp_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
`if FULL_RATE
LABEL __NL rff_0 | cmd_wdp_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
LABEL __NL rff_0 | cmd_wdp_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
...
LABEL __NL rff_0 | cmd_wdp_dm_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
`if FULL_RATE
LABEL __NL rff_0 | cmd_wdp_dm_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
LABEL __NL rff_0 | cmd_wdp_dm_lfsr | jump_0 | jump_reg_0 | ac_write_data | do_0 | dm_0 # ** WRITE data LFSR
LABEL __NL rff_0 | cmd_def | jump_0 | jump_reg_0 | ac_nop | do_0 | dm_0 # no-op
