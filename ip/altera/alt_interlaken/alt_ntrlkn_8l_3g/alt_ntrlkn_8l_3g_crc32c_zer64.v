...
module alt_ntrlkn_8l_3g_crc32c_zer64 (c,crc_out);
input[31:0] c;
output[31:0] crc_out;
wire[31:0] crc_out;
...
generate
	if (METHOD == 0)
		alt_ntrlkn_8l_3g_crc32c_zer64_flat cc (.c(c),.crc_out(crc_out));
	else
		alt_ntrlkn_8l_3g_crc32c_zer64_factor cc (.c(c),.crc_out(crc_out));
endgenerate
