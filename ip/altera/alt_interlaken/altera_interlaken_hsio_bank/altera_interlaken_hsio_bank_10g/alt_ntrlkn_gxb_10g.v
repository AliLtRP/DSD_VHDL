...
// ============================================================
// File Name: alt_ntrlkn_gxb_10g.v
// Megafunction Name(s):
// 			alt4gxb
//
...
//alt4gxb CBX_AUTO_BLACKBOX="ALL" device_family="Stratix IV" effective_data_rate="10312.5 Mbps" enable_lc_tx_pll="false" equalizer_ctrl_a_setting=0 equalizer_ctrl_b_setting=0 equalizer_ctrl_c_setting=0 equalizer_ctrl_d_setting=0 equalizer_ctrl_v_setting=0 equalizer_dcgain_setting=0 gen_reconfig_pll="false" gx_channel_type="gt" gxb_analog_power="AUTO" gxb_powerdown_width=1 input_clock_frequency="322.265625 MHz" intended_device_speed_grade="2" intended_device_variant="GT" loopback_mode="slb" number_of_channels=4 number_of_quads=1 operation_mode="duplex" pll_control_width=1 pll_pfd_fb_mode="internal" preemphasis_ctrl_1stposttap_setting=0 protocol="basic" receiver_termination="OCT_100_OHMS" reconfig_calibration="true" reconfig_dprio_mode=1 reconfig_fromgxb_port_width=17 reconfig_togxb_port_width=4 rx_8b_10b_mode="none" rx_allow_align_polarity_inversion="false" rx_allow_pipe_polarity_inversion="false" rx_bitslip_enable="true" rx_byte_ordering_mode="none" rx_channel_width=40 rx_common_mode="0.82v" rx_cru_bandwidth_type="auto" rx_cru_inclock0_period=3103 rx_cru_m_divider=16 rx_cru_n_divider=1 rx_cru_vco_post_scale_divider=1 rx_data_rate=10312.5 rx_data_rate_remainder=0 rx_datapath_low_latency_mode="true" rx_datapath_protocol="basic" rx_digitalreset_port_width=4 rx_dwidth_factor=4 rx_enable_bit_reversal="false" rx_enable_deep_align_byte_swap="false" rx_enable_lock_to_data_sig="false" rx_enable_lock_to_refclk_sig="false" rx_enable_self_test_mode="false" rx_flip_rx_out="false" rx_force_signal_detect="true" rx_phfiforegmode="false" rx_ppmselect=32 rx_rate_match_fifo_mode="none" rx_run_length=40 rx_run_length_enable="true" rx_signal_detect_loss_threshold=1 rx_signal_detect_threshold=1 rx_signal_detect_valid_threshold=1 rx_use_align_state_machine="true" rx_use_clkout="true" rx_use_coreclk="true" rx_use_cruclk="true" rx_use_deserializer_double_data_mode="true" rx_use_deskew_fifo="false" rx_use_double_data_mode="true" rx_use_external_termination="false" rx_word_aligner_num_byte=2 starting_channel_number=0 transmitter_termination="OCT_100_OHMS" tx_8b_10b_mode="none" tx_allow_polarity_inversion="false" tx_analog_power="auto" tx_channel_width=40 tx_clkout_width=4 tx_common_mode="0.65v" tx_data_rate=10312.5 tx_data_rate_remainder=0 tx_datapath_low_latency_mode="true" tx_digitalreset_port_width=4 tx_dwidth_factor=4 tx_enable_bit_reversal="false" tx_enable_self_test_mode="false" tx_flip_tx_in="false" tx_pll_bandwidth_type="auto" tx_pll_clock_post_divider=1 tx_pll_inclk0_period=3103 tx_pll_m_divider=16 tx_pll_n_divider=1 tx_pll_type="CMU" tx_pll_vco_post_scale_divider=1 tx_slew_rate="off" tx_transmit_protocol="basic" tx_use_coreclk="true" tx_use_double_data_mode="true" tx_use_external_termination="false" tx_use_serializer_double_data_mode="true" use_calibration_block="true" vod_ctrl_setting=3 cal_blk_clk cal_blk_powerdown gxb_powerdown pll_inclk pll_locked pll_powerdown reconfig_clk reconfig_fromgxb reconfig_togxb rx_analogreset rx_clkout rx_coreclk rx_cruclk rx_datain rx_dataout rx_digitalreset rx_freqlocked rx_phase_comp_fifo_error rx_pll_locked rx_seriallpbken tx_clkout tx_coreclk tx_datain tx_dataout tx_digitalreset tx_phase_comp_fifo_error
...
module  alt_ntrlkn_gxb_10g_alt4gxb_t9d9
	( 
	cal_blk_clk,
	cal_blk_powerdown,
	gxb_powerdown,
...
`endif
	...
	tri0   [3:0]  rx_coreclk;
	tri0   [3:0]  rx_cruclk;
	tri0   [3:0]  rx_digitalreset;
	tri0   [3:0]  rx_seriallpbken;
	tri0   [3:0]  tx_coreclk;
	tri0   [159:0]  tx_datain;
	tri0   [3:0]  tx_digitalreset;
`ifndef ALTERA_RESERVED_QIS
// synopsys translate_on
`endif
	...
	parameter	starting_channel_number = 0;
      parameter       effective_data_rate = "10312.5 Mbps";
      parameter       input_clock_frequency = "322.265625 MHz";
      parameter       input_clock_period = 3103;
	...
	wire  [1:0]   wire_ch_clk_div2_analogfastrefclkout;
	wire  [1:0]   wire_ch_clk_div2_analogrefclkout;
	wire  wire_ch_clk_div2_analogrefclkpulse;
	wire  [99:0]   wire_ch_clk_div2_dprioout;
	wire  [1:0]   wire_ch_clk_div3_analogfastrefclkout;
	wire  [1:0]   wire_ch_clk_div3_analogrefclkout;
	wire  wire_ch_clk_div3_analogrefclkpulse;
	wire  [99:0]   wire_ch_clk_div3_dprioout;
	...
	wire  [7:0]  analogfastrefclkout;
	wire  [7:0]  analogrefclkout;
	wire  [3:0]  analogrefclkpulse;
	...
	wire [3:0]  rx_locktorefclk;
	wire  [3:0]  rx_locktorefclk_wire;
	wire  [159:0]  rx_out_wire;
	...
	defparam
		...
		ch_clk_div0.effective_data_rate = effective_data_rate,
	...
	defparam
		...
		ch_clk_div1.effective_data_rate = effective_data_rate,
	...
	stratixiv_hssi_clock_divider   ch_clk_div2
	( 
	...
	.coreclkout(),
	.dpriodisable(w_cent_unit_dpriodisableout1w[0]),
	.dprioin(cent_unit_cmudividerdprioout[299:200]),
	...
	defparam
		ch_clk_div2.channel_num = ((starting_channel_number + 2) % 4),
		ch_clk_div2.divide_by = 5,
		ch_clk_div2.divider_type = "CHANNEL_REGULAR",
		ch_clk_div2.effective_data_rate = effective_data_rate,
		ch_clk_div2.enable_dynamic_divider = "false",
		ch_clk_div2.enable_refclk_out = "false",
		ch_clk_div2.inclk_select = 0,
		ch_clk_div2.logical_channel_address = (starting_channel_number + 2),
		ch_clk_div2.pre_divide_by = 1,
		ch_clk_div2.select_local_rate_switch_done = "false",
		ch_clk_div2.sim_analogfastrefclkout_phase_shift = 0,
		ch_clk_div2.sim_analogrefclkout_phase_shift = 0,
		ch_clk_div2.sim_coreclkout_phase_shift = 0,
		ch_clk_div2.sim_refclkout_phase_shift = 0,
		ch_clk_div2.use_coreclk_out_post_divider = "false",
		ch_clk_div2.use_refclk_post_divider = "false",
		ch_clk_div2.use_vco_bypass = "false",
		ch_clk_div2.lpm_type = "stratixiv_hssi_clock_divider";
	stratixiv_hssi_clock_divider   ch_clk_div3
	( 
	...
	.coreclkout(),
	.dpriodisable(w_cent_unit_dpriodisableout1w[0]),
	.dprioin(cent_unit_cmudividerdprioout[399:300]),
	...
	defparam
		ch_clk_div3.channel_num = ((starting_channel_number + 3) % 4),
		ch_clk_div3.divide_by = 5,
		ch_clk_div3.divider_type = "CHANNEL_REGULAR",
		ch_clk_div3.effective_data_rate = effective_data_rate,
		ch_clk_div3.enable_dynamic_divider = "false",
		ch_clk_div3.enable_refclk_out = "false",
		ch_clk_div3.inclk_select = 0,
		ch_clk_div3.logical_channel_address = (starting_channel_number + 3),
		ch_clk_div3.pre_divide_by = 1,
		ch_clk_div3.select_local_rate_switch_done = "false",
		ch_clk_div3.sim_analogfastrefclkout_phase_shift = 0,
		ch_clk_div3.sim_analogrefclkout_phase_shift = 0,
		ch_clk_div3.sim_coreclkout_phase_shift = 0,
		ch_clk_div3.sim_refclkout_phase_shift = 0,
		ch_clk_div3.use_coreclk_out_post_divider = "false",
		ch_clk_div3.use_refclk_post_divider = "false",
		ch_clk_div3.use_vco_bypass = "false",
		ch_clk_div3.lpm_type = "stratixiv_hssi_clock_divider";
	...
	defparam
		...
		tx_pll0.inclk0_input_period = 3103,
		tx_pll0.input_clock_frequency = "322.265625 MHz",
	...
	defparam
		...
		receive_pcs2.rx_phfifo_wait_cnt = 0,
	...
	defparam
		...
		receive_pcs3.rx_phfifo_wait_cnt = 0,
	...
	defparam
		...
		transmit_pcs2.channel_bonding = "none",
		...
		transmit_pcs2.ph_fifo_xn_mapping2 = "none",
		transmit_pcs2.ph_fifo_xn_select = 1,
		...
		transmit_pcs2.refclk_select = "local",
	...
	defparam
		...
		transmit_pcs3.channel_bonding = "none",
		...
		transmit_pcs3.ph_fifo_xn_mapping2 = "none",
		transmit_pcs3.ph_fifo_xn_select = 1,
		...
		transmit_pcs3.refclk_select = "local",
	...
	.fastrefclk0in(analogfastrefclkout[5:4]),
	.fastrefclk1in({2{1'b0}}),
	.fastrefclk2in({2{1'b0}}),
	.fastrefclk4in({2{1'b0}}),
	.forceelecidle(1'b0),
	.powerdn(cent_unit_txobpowerdn[2]),
	.refclk0in({analogrefclkout[5:4]}),
	...
	defparam
		...
		transmit_pma2.channel_type = "gt",
		transmit_pma2.clkin_select = 0,
		...
		transmit_pma2.physical_clkin0_mapping = "x1",
	...
	.fastrefclk0in(analogfastrefclkout[7:6]),
	.fastrefclk1in({2{1'b0}}),
	.fastrefclk2in({2{1'b0}}),
	.fastrefclk4in({2{1'b0}}),
	.forceelecidle(1'b0),
	.powerdn(cent_unit_txobpowerdn[3]),
	.refclk0in({analogrefclkout[7:6]}),
	...
	defparam
		...
		transmit_pma3.channel_type = "gt",
		transmit_pma3.clkin_select = 0,
		...
		transmit_pma3.physical_clkin0_mapping = "x1",
	...
	assign
		...
		clk_div_cmudividerdprioin = {{2{{100{1'b0}}}}, wire_ch_clk_div3_dprioout, wire_ch_clk_div2_dprioout, wire_ch_clk_div1_dprioout, wire_ch_clk_div0_dprioout},
		...
		rx_analogreset_in = {{2{1'b0}}, ((~ reconfig_togxb_busy) & rx_analogreset[3]), ((~ reconfig_togxb_busy) & rx_analogreset[2]), ((~ reconfig_togxb_busy) & rx_analogreset[1]), ((~ reconfig_togxb_busy) & rx_analogreset[0])},
		rx_analogreset_out = {wire_cent_unit0_rxanalogresetout[5:0]},
		rx_clkout = {rx_clkout_wire[3:0]},
		...
		rx_dataout = {rx_out_wire[159:0]},
		rx_deserclock_in = {rx_pll_clkout[15:0]},
		rx_digitalreset_in = {rx_digitalreset[3:0]},
		...
		rx_out_wire = {wire_receive_pcs3_dataout[39:0], wire_receive_pcs2_dataout[39:0], wire_receive_pcs1_dataout[39:0], wire_receive_pcs0_dataout[39:0]},
		...
		tx_clkout = {tx_core_clkout_wire[3:0]},
		...
		tx_core_clkout_wire = {4{tx_clkout_int_wire[0]}},
		tx_coreclk_in = {tx_coreclk[3:0]},
		tx_datain_wire = {tx_datain[159:0]},
		...
		tx_digitalreset_in = {tx_digitalreset[3:0]},
...
endmodule //alt_ntrlkn_gxb_10g_alt4gxb_t9d9
//VALID FILE
...
`endif
	...
	wire [159:0] rx_dataout = sub_wire5[159:0];
	wire [3:0] rx_phase_comp_fifo_error = sub_wire6[3:0];
	wire [3:0] tx_clkout = sub_wire7[3:0];
	wire [3:0] tx_dataout = sub_wire8[3:0];
	wire [3:0] tx_phase_comp_fifo_error = sub_wire9[3:0];

	alt_ntrlkn_gxb_10g_alt4gxb_t9d9	alt_ntrlkn_gxb_10g_alt4gxb_t9d9_component (
				.pll_inclk (pll_inclk),
				...
				.tx_phase_comp_fifo_error (sub_wire9));
	defparam
		alt_ntrlkn_gxb_10g_alt4gxb_t9d9_component.starting_channel_number = starting_channel_number;
	defparam
		alt_ntrlkn_gxb_10g_alt4gxb_t9d9_component.effective_data_rate = effective_data_rate;
	defparam
		alt_ntrlkn_gxb_10g_alt4gxb_t9d9_component.input_clock_period = input_clock_period;
	defparam
		alt_ntrlkn_gxb_10g_alt4gxb_t9d9_component.input_clock_frequency = input_clock_frequency;
...
// Retrieval info: PRIVATE: WIZ_DPRIO_REF_CLK0_FREQ STRING "318.75"
...
// Retrieval info: PRIVATE: WIZ_INCLK_FREQ_ARRAY STRING "318.75 637.5"
...
// Retrieval info: CONSTANT: INPUT_CLOCK_FREQUENCY STRING "322.265625 MHz"
...
// Retrieval info: CONSTANT: RX_DATA_RATE NUMERIC "10312.5"
...
// Retrieval info: CONSTANT: TX_DATA_RATE NUMERIC "10312.5"
...
// Retrieval info: CONSTANT: TX_PLL_INCLK0_PERIOD NUMERIC "3103"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g.ppf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_10g_bb.v TRUE
