...
// ============================================================
// File Name: alt_ntrlkn_reconfig_bpcs_3g.v
// Megafunction Name(s):
// 			alt2gxb_reconfig
//
...
module  alt_ntrlkn_reconfig_bpcs_3g_alt_dprio_2vj
	( 
	address,
	busy,
	datain,
...
endmodule //alt_ntrlkn_reconfig_bpcs_3g_alt_dprio_2vj
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_ntrlkn_reconfig_bpcs_3g_mux_76a
	( 
	data,
	result,
	sel) ;
...
endmodule //alt_ntrlkn_reconfig_bpcs_3g_mux_76a

//synthesis_resources = alt_cal 1 lpm_add_sub 10 lpm_compare 8 lpm_counter 4 lpm_decode 3 lut 2 reg 224 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  alt_ntrlkn_reconfig_bpcs_3g_alt2gxb_reconfig_ckn1
	( 
	busy,
	data_valid,
	read,
	...
	input   [3:0]  rx_eqctrl;
	output   [15:0]  rx_eqctrl_out;
	input   [2:0]  rx_eqdcgain;
	output   [11:0]  rx_eqdcgain_out;
	input   [4:0]  tx_preemp_0t;
	output   [19:0]  tx_preemp_0t_out;
	input   [4:0]  tx_preemp_1t;
	output   [19:0]  tx_preemp_1t_out;
	input   [4:0]  tx_preemp_2t;
	output   [19:0]  tx_preemp_2t_out;
	input   [2:0]  tx_vodctrl;
	output   [11:0]  tx_vodctrl_out;
	input   write_all;
`ifndef ALTERA_RESERVED_QIS
// synopsys translate_off
`endif
...
`endif
	...
	wire	[15:0]	wire_rx_eqctrl_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[15:0]	rx_eqctrl_reg;
	wire	[15:0]	wire_rx_eqctrl_reg_ena;
	wire	[11:0]	wire_rx_equalizer_dcgain_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[11:0]	rx_equalizer_dcgain_reg;
	wire	[11:0]	wire_rx_equalizer_dcgain_reg_ena;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[1:0]	state_mc_reg;
	wire	[3:0]	wire_tx_preemp_0t_inv_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[3:0]	tx_preemp_0t_inv_reg;
	wire	[3:0]	wire_tx_preemp_0t_inv_reg_ena;
	wire	[3:0]	wire_tx_preemp_2t_inv_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[3:0]	tx_preemp_2t_inv_reg;
	wire	[3:0]	wire_tx_preemp_2t_inv_reg_ena;
	wire	[19:0]	wire_tx_preemphasisctrl_1stposttap_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[19:0]	tx_preemphasisctrl_1stposttap_reg;
	wire	[19:0]	wire_tx_preemphasisctrl_1stposttap_reg_ena;
	wire	[15:0]	wire_tx_preemphasisctrl_2ndposttap_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[15:0]	tx_preemphasisctrl_2ndposttap_reg;
	wire	[15:0]	wire_tx_preemphasisctrl_2ndposttap_reg_ena;
	wire	[15:0]	wire_tx_preemphasisctrl_pretap_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[15:0]	tx_preemphasisctrl_pretap_reg;
	wire	[15:0]	wire_tx_preemphasisctrl_pretap_reg_ena;
	wire	[11:0]	wire_tx_vodctrl_reg_d;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	[11:0]	tx_vodctrl_reg;
	wire	[11:0]	wire_tx_vodctrl_reg_ena;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	wr_addr_inc_reg;
	(* ALTERA_ATTRIBUTE = {"POWER_UP_LEVEL=LOW"} *)
	reg	wr_rd_pulse_reg;
	...
	wire  [15:0]  tx_preemp_0t_out_wire;
	wire  [3:0]  tx_preemp_0t_wire;
	wire  [15:0]  tx_preemp_2t_out_wire;
	wire  [3:0]  tx_preemp_2t_wire;
	wire  tx_reconfig;
	wire  [10:0]  w325w;
	wire  [2:0]  w_rx_eqa562w;
	wire  [2:0]  w_rx_eqb561w;
	wire  [2:0]  w_rx_eqc560w;
	wire  [2:0]  w_rx_eqd559w;
	wire  [2:0]  w_rx_eqv563w;
	wire  wr_pulse;
	wire  write_addr_inc;
	...
	alt_ntrlkn_reconfig_bpcs_3g_alt_dprio_2vj   dprio
	( 
	...
	assign
		wire_rx_eqctrl_reg_d = {4{(({4{read_state}} & (((({{2{1'b0}}, (w_rx_eqv563w[2] & (~ (w_rx_eqv563w[1] ^ w_rx_eqv563w[0]))), (((w_rx_eqv563w[2] & w_rx_eqv563w[1]) & w_rx_eqv563w[0]) | (((~ w_rx_eqv563w[2]) & (~ w_rx_eqv563w[1])) & (~ w_rx_eqv563w[0])))} & {4{(((((w_rx_eqd559w[2] & w_rx_eqd559w[1]) & w_rx_eqd559w[0]) & (~ ((w_rx_eqc560w[2] & w_rx_eqc560w[1]) & w_rx_eqc560w[0]))) & (~ ((w_rx_eqb561w[2] & w_rx_eqb561w[1]) & w_rx_eqb561w[0]))) & (~ ((w_rx_eqa562w[2] & w_rx_eqa562w[1]) & w_rx_eqa562w[0])))}}) | ({1'b0, 1'b1, ((w_rx_eqv563w[2] & w_rx_eqv563w[1]) & w_rx_eqv563w[0]), ((w_rx_eqv563w[2] & (~ w_rx_eqv563w[1])) & (~ w_rx_eqv563w[0]))} & {4{(((((w_rx_eqd559w[2] & w_rx_eqd559w[1]) & w_rx_eqd559w[0]) & ((w_rx_eqc560w[2] & w_rx_eqc560w[1]) & w_rx_eqc560w[0])) & (~ ((w_rx_eqb561w[2] & w_rx_eqb561w[1]) & w_rx_eqb561w[0]))) & (~ ((w_rx_eqa562w[2] & w_rx_eqa562w[1]) & w_rx_eqa562w[0])))}})) | ({w_rx_eqv563w[2], (~ w_rx_eqv563w[2]), (((w_rx_eqv563w[2] & w_rx_eqv563w[1]) & w_rx_eqv563w[0]) | (((~ w_rx_eqv563w[2]) & (~ w_rx_eqv563w[1])) & (~ w_rx_eqv563w[0]))), ((~ w_rx_eqv563w[1]) & (~ (w_rx_eqv563w[2] ^ w_rx_eqv563w[0])))} & {4{(((((w_rx_eqd559w[2] & w_rx_eqd559w[1]) & w_rx_eqd559w[0]) & ((w_rx_eqc560w[2] & w_rx_eqc560w[1]) & w_rx_eqc560w[0])) & ((w_rx_eqb561w[2] & w_rx_eqb561w[1]) & w_rx_eqb561w[0])) & (~ ((w_rx_eqa562w[2] & w_rx_eqa562w[1]) & w_rx_eqa562w[0])))}})) | ({1'b1, ((w_rx_eqv563w[2] | w_rx_eqv563w[1]) | w_rx_eqv563w[0]), (((~ w_rx_eqv563w[1]) & (~ (w_rx_eqv563w[2] ^ w_rx_eqv563w[0]))) | ((w_rx_eqv563w[2] & w_rx_eqv563w[1]) & w_rx_eqv563w[0])), (((~ w_rx_eqv563w[1]) & (~ w_rx_eqv563w[0])) | ((w_rx_eqv563w[2] & w_rx_eqv563w[1]) & w_rx_eqv563w[0]))} & {4{(((((w_rx_eqd559w[2] & w_rx_eqd559w[1]) & w_rx_eqd559w[0]) & ((w_rx_eqc560w[2] & w_rx_eqc560w[1]) & w_rx_eqc560w[0])) & ((w_rx_eqb561w[2] & w_rx_eqb561w[1]) & w_rx_eqb561w[0])) & ((w_rx_eqa562w[2] & w_rx_eqa562w[1]) & w_rx_eqa562w[0]))}}))) | ({4{write_state}} & rx_eqctrl))}};
	assign
		wire_rx_eqctrl_reg_ena = {{4{(((read_word_68_6B_data_valid & read_state) & channel_valid[3]) | (write_word_68_6B_data_valid & write_state))}}, {4{(((read_word_68_6B_data_valid & read_state) & channel_valid[2]) | (write_word_68_6B_data_valid & write_state))}}, {4{(((read_word_68_6B_data_valid & read_state) & channel_valid[1]) | (write_word_68_6B_data_valid & write_state))}}, {4{(((read_word_68_6B_data_valid & read_state) & channel_valid[0]) | (write_word_68_6B_data_valid & write_state))}}};
	// synopsys translate_off
	initial
	...
	assign
		wire_rx_equalizer_dcgain_reg_d = {4{(({3{read_state}} & {wire_dprio_dataout[10], (wire_dprio_dataout[8] & (~ wire_dprio_dataout[10])), (((wire_dprio_dataout[7] ^ wire_dprio_dataout[8]) ^ wire_dprio_dataout[9]) ^ wire_dprio_dataout[10])}) | ({3{write_state}} & rx_eqdcgain))}};
	assign
		wire_rx_equalizer_dcgain_reg_ena = {{3{(((read_word_64_67_data_valid & read_state) & channel_valid[3]) | (write_word_64_67_data_valid & write_state))}}, {3{(((read_word_64_67_data_valid & read_state) & channel_valid[2]) | (write_word_64_67_data_valid & write_state))}}, {3{(((read_word_64_67_data_valid & read_state) & channel_valid[1]) | (write_word_64_67_data_valid & write_state))}}, {3{(((read_word_64_67_data_valid & read_state) & channel_valid[0]) | (write_word_64_67_data_valid & write_state))}}};
	// synopsys translate_off
	initial
		state_mc_reg = 2'b00;
	// synopsys translate_on
	...
	assign
		wire_tx_preemp_0t_inv_reg_d = {4{((read_state & wire_dprio_dataout[4]) | (write_state & (~ tx_preemp_0t[4])))}};
	assign
		wire_tx_preemp_0t_inv_reg_ena = {(((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[3]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[2]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[1]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[0]) | (write_word_7c_7f_inv_data_valid & write_state))};
	// synopsys translate_off
	initial
	...
	assign
		wire_tx_preemp_2t_inv_reg_d = {4{((read_state & wire_dprio_dataout[3]) | (write_state & (~ tx_preemp_2t[4])))}};
	assign
		wire_tx_preemp_2t_inv_reg_ena = {(((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[3]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[2]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[1]) | (write_word_7c_7f_inv_data_valid & write_state)), (((read_word_7c_7f_inv_data_valid & read_state) & channel_valid[0]) | (write_word_7c_7f_inv_data_valid & write_state))};
	// synopsys translate_off
	initial
	...
	assign
		wire_tx_preemphasisctrl_1stposttap_reg_d = {4{(({5{read_state}} & wire_dprio_dataout[15:11]) | ({5{write_state}} & tx_preemp_1t))}};
	assign
		wire_tx_preemphasisctrl_1stposttap_reg_ena = {{5{(((read_word_preemp_1t_data_valid & read_state) & channel_valid[3]) | (write_word_preemp1t_data_valid & write_state))}}, {5{(((read_word_preemp_1t_data_valid & read_state) & channel_valid[2]) | (write_word_preemp1t_data_valid & write_state))}}, {5{(((read_word_preemp_1t_data_valid & read_state) & channel_valid[1]) | (write_word_preemp1t_data_valid & write_state))}}, {5{(((read_word_preemp_1t_data_valid & read_state) & channel_valid[0]) | (write_word_preemp1t_data_valid & write_state))}}};
	// synopsys translate_off
	initial
	...
	assign
		wire_tx_preemphasisctrl_2ndposttap_reg_d = {4{(({4{read_state}} & wire_dprio_dataout[7:4]) | ({4{write_state}} & tx_preemp_2t_wire[3:0]))}};
	assign
		wire_tx_preemphasisctrl_2ndposttap_reg_ena = {{4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[3]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[2]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[1]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[0]) | (write_word_7c_7f_data_valid & write_state))}}};
	// synopsys translate_off
	initial
	...
	assign
		wire_tx_preemphasisctrl_pretap_reg_d = {4{(({4{read_state}} & wire_dprio_dataout[3:0]) | ({4{write_state}} & tx_preemp_0t_wire[3:0]))}};
	assign
		wire_tx_preemphasisctrl_pretap_reg_ena = {{4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[3]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[2]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[1]) | (write_word_7c_7f_data_valid & write_state))}}, {4{(((read_word_7c_7f_data_valid & read_state) & channel_valid[0]) | (write_word_7c_7f_data_valid & write_state))}}};
	// synopsys translate_off
	initial
	...
	defparam
		addr_cntr.lpm_modulus = 4,
		addr_cntr.lpm_port_updown = "PORT_UNUSED",
		addr_cntr.lpm_width = 2,
	...
	defparam
		chl_addr_decode.lpm_decodes = 4,
		chl_addr_decode.lpm_width = 2,
	...
	alt_ntrlkn_reconfig_bpcs_3g_mux_76a   aeq_ch_done_mux
	( 
	.data(aeq_ch_done),
	...
	assign
		...
		tx_preemp_0t_out = {(~ tx_preemp_0t_inv_reg[3]), wire_add_sub13_result, (~ tx_preemp_0t_inv_reg[2]), wire_add_sub12_result, (~ tx_preemp_0t_inv_reg[1]), wire_add_sub11_result, (~ tx_preemp_0t_inv_reg[0]), wire_add_sub10_result},
		...
		tx_preemp_2t_out = {(~ tx_preemp_2t_inv_reg[3]), wire_add_sub17_result, (~ tx_preemp_2t_inv_reg[2]), wire_add_sub16_result, (~ tx_preemp_2t_inv_reg[1]), wire_add_sub15_result, (~ tx_preemp_2t_inv_reg[0]), wire_add_sub14_result},
		...
		w_rx_eqa562w = wire_dprio_dataout[14:12],
		w_rx_eqb561w = wire_dprio_dataout[11:9],
		w_rx_eqc560w = wire_dprio_dataout[8:6],
		w_rx_eqd559w = wire_dprio_dataout[5:3],
		w_rx_eqv563w = wire_dprio_dataout[2:0],
...
endmodule //alt_ntrlkn_reconfig_bpcs_3g_alt2gxb_reconfig_ckn1
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module alt_ntrlkn_reconfig_bpcs_3g (
	read,
	reconfig_clk,
	reconfig_fromgxb,
	rx_eqctrl,
	...
	wire [19:0] tx_preemp_2t_out = sub_wire1[19:0];
	wire [11:0] tx_vodctrl_out = sub_wire2[11:0];
	wire  data_valid = sub_wire3;
	wire [19:0] tx_preemp_0t_out = sub_wire4[19:0];
	wire  busy = sub_wire5;
	wire [15:0] rx_eqctrl_out = sub_wire6[15:0];
	wire [19:0] tx_preemp_1t_out = sub_wire7[19:0];
	wire [11:0] rx_eqdcgain_out = sub_wire8[11:0];

	alt_ntrlkn_reconfig_bpcs_3g_alt2gxb_reconfig_ckn1	alt_ntrlkn_reconfig_bpcs_3g_alt2gxb_reconfig_ckn1_component (
	 ...
	 clearbox_defparam = "base_port_width=1;cbx_blackbox_list=-lpm_mux;enable_chl_addr_for_analog_ctrl=FALSE;intended_device_family=Stratix IV;number_of_channels=4;number_of_reconfig_ports=1;read_base_port_width=4;rx_eqdcgain_port_width=3;tx_preemp_port_width=5;enable_buf_cal=true;reconfig_fromgxb_width=17;reconfig_togxb_width=4;" */;
...
// Retrieval info: USED_PORT: rx_eqctrl_out 0 0 16 0 OUTPUT NODEFVAL "rx_eqctrl_out[15..0]"
// Retrieval info: USED_PORT: rx_eqdcgain 0 0 3 0 INPUT NODEFVAL "rx_eqdcgain[2..0]"
// Retrieval info: USED_PORT: rx_eqdcgain_out 0 0 12 0 OUTPUT NODEFVAL "rx_eqdcgain_out[11..0]"
// Retrieval info: USED_PORT: tx_preemp_0t 0 0 5 0 INPUT NODEFVAL "tx_preemp_0t[4..0]"
// Retrieval info: USED_PORT: tx_preemp_0t_out 0 0 20 0 OUTPUT NODEFVAL "tx_preemp_0t_out[19..0]"
// Retrieval info: USED_PORT: tx_preemp_1t 0 0 5 0 INPUT NODEFVAL "tx_preemp_1t[4..0]"
// Retrieval info: USED_PORT: tx_preemp_1t_out 0 0 20 0 OUTPUT NODEFVAL "tx_preemp_1t_out[19..0]"
// Retrieval info: USED_PORT: tx_preemp_2t 0 0 5 0 INPUT NODEFVAL "tx_preemp_2t[4..0]"
// Retrieval info: USED_PORT: tx_preemp_2t_out 0 0 20 0 OUTPUT NODEFVAL "tx_preemp_2t_out[19..0]"
// Retrieval info: USED_PORT: tx_vodctrl 0 0 3 0 INPUT NODEFVAL "tx_vodctrl[2..0]"
// Retrieval info: USED_PORT: tx_vodctrl_out 0 0 12 0 OUTPUT NODEFVAL "tx_vodctrl_out[11..0]"
...
// Retrieval info: CONNECT: rx_eqctrl_out 0 0 16 0 @rx_eqctrl_out 0 0 16 0
// Retrieval info: CONNECT: rx_eqdcgain_out 0 0 12 0 @rx_eqdcgain_out 0 0 12 0
// Retrieval info: CONNECT: tx_preemp_0t_out 0 0 20 0 @tx_preemp_0t_out 0 0 20 0
// Retrieval info: CONNECT: tx_preemp_1t_out 0 0 20 0 @tx_preemp_1t_out 0 0 20 0
// Retrieval info: CONNECT: tx_preemp_2t_out 0 0 20 0 @tx_preemp_2t_out 0 0 20 0
// Retrieval info: CONNECT: tx_vodctrl_out 0 0 12 0 @tx_vodctrl_out 0 0 12 0
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_reconfig_bpcs_3g_bb.v TRUE
