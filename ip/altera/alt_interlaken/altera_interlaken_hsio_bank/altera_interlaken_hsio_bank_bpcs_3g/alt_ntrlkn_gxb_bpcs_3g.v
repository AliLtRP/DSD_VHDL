...
// ============================================================
// File Name: alt_ntrlkn_gxb_bpcs_3g.v
// Megafunction Name(s):
// 			alt4gxb
//
...
//alt4gxb CBX_AUTO_BLACKBOX="ALL" device_family="Stratix IV" effective_data_rate="3125 Mbps" enable_lc_tx_pll="false" equalizer_ctrl_a_setting=0 equalizer_ctrl_b_setting=0 equalizer_ctrl_c_setting=0 equalizer_ctrl_d_setting=0 equalizer_ctrl_v_setting=0 equalizer_dcgain_setting=0 gen_reconfig_pll="false" gx_channel_type="auto" gxb_analog_power="AUTO" gxb_powerdown_width=1 input_clock_frequency="156.25 MHz" intended_device_speed_grade="2" intended_device_variant="GX" loopback_mode="slb" number_of_channels=4 number_of_quads=1 operation_mode="duplex" pll_control_width=1 pll_pfd_fb_mode="internal" preemphasis_ctrl_1stposttap_setting=0 protocol="basic" receiver_termination="OCT_100_OHMS" reconfig_calibration="true" reconfig_dprio_mode=1 reconfig_fromgxb_port_width=17 reconfig_togxb_port_width=4 rx_8b_10b_mode="none" rx_allow_align_polarity_inversion="false" rx_allow_pipe_polarity_inversion="false" rx_bitslip_enable="true" rx_byte_ordering_mode="none" rx_channel_width=20 rx_common_mode="0.82v" rx_cru_bandwidth_type="auto" rx_cru_inclock0_period=6400 rx_cru_m_divider=10 rx_cru_n_divider=1 rx_cru_vco_post_scale_divider=2 rx_data_rate=3125 rx_data_rate_remainder=0 rx_datapath_low_latency_mode="true" rx_datapath_protocol="basic" rx_digitalreset_port_width=4 rx_dwidth_factor=2 rx_enable_bit_reversal="false" rx_enable_deep_align_byte_swap="false" rx_enable_lock_to_data_sig="false" rx_enable_lock_to_refclk_sig="false" rx_enable_self_test_mode="false" rx_flip_rx_out="false" rx_force_signal_detect="true" rx_phfiforegmode="false" rx_ppmselect=32 rx_rate_match_fifo_mode="none" rx_run_length=40 rx_run_length_enable="true" rx_signal_detect_loss_threshold=1 rx_signal_detect_threshold=1 rx_signal_detect_valid_threshold=1 rx_use_align_state_machine="true" rx_use_clkout="true" rx_use_coreclk="true" rx_use_cruclk="true" rx_use_deserializer_double_data_mode="true" rx_use_deskew_fifo="false" rx_use_double_data_mode="false" rx_use_external_termination="false" rx_word_aligner_num_byte=2 starting_channel_number=0 transmitter_termination="OCT_100_OHMS" tx_8b_10b_mode="none" tx_allow_polarity_inversion="false" tx_analog_power="1.4v" tx_channel_width=20 tx_clkout_width=4 tx_common_mode="0.65v" tx_data_rate=3125 tx_data_rate_remainder=0 tx_datapath_low_latency_mode="true" tx_digitalreset_port_width=4 tx_dwidth_factor=2 tx_enable_bit_reversal="false" tx_enable_self_test_mode="false" tx_flip_tx_in="false" tx_pll_bandwidth_type="auto" tx_pll_clock_post_divider=1 tx_pll_inclk0_period=6400 tx_pll_m_divider=10 tx_pll_n_divider=1 tx_pll_type="CMU" tx_pll_vco_post_scale_divider=2 tx_slew_rate="off" tx_transmit_protocol="basic" tx_use_coreclk="true" tx_use_double_data_mode="false" tx_use_external_termination="false" tx_use_serializer_double_data_mode="true" use_calibration_block="true" vod_ctrl_setting=3 cal_blk_clk cal_blk_powerdown gxb_powerdown pll_inclk pll_locked pll_powerdown reconfig_clk reconfig_fromgxb reconfig_togxb rx_analogreset rx_clkout rx_coreclk rx_cruclk rx_datain rx_dataout rx_digitalreset rx_freqlocked rx_phase_comp_fifo_error rx_seriallpbken tx_clkout tx_coreclk tx_datain tx_dataout tx_digitalreset tx_phase_comp_fifo_error
...
module  alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9
	( 
	cal_blk_clk,
	cal_blk_powerdown,
	gxb_powerdown,
...
`endif
	...
	parameter	starting_channel_number = 0;
      parameter       effective_data_rate = "3125 Mbps";
      parameter       input_clock_frequency = "156.25 MHz";
      parameter       input_clock_period = 6400;
...
endmodule //alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9
//VALID FILE
...
`endif
	...
	alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9	alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9_component (
				.pll_inclk (pll_inclk),
	...
	defparam
		alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9_component.starting_channel_number = starting_channel_number;
	defparam
		alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9_component.effective_data_rate = effective_data_rate;
	defparam
		alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9_component.input_clock_frequency = input_clock_frequency;
	defparam
		alt_ntrlkn_gxb_bpcs_3g_alt4gxb_cvb9_component.input_clock_period = input_clock_period;
endmodule
...
// Retrieval info: PRIVATE: WIZ_INCLK_FREQ_ARRAY STRING "62.5 78.125 97.65625 125.0 156.25 195.3125 250.0 312.5 390.625 500.0 625.0"
...
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g.ppf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_ntrlkn_gxb_bpcs_3g_bb.v TRUE
