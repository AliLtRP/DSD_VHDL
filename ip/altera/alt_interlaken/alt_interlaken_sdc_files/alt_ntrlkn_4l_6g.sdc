...
create_clock -name {tx_mac_clk_clk} -period 5.02 -waveform { 0.000 2.51 } [get_ports {*tx_mac_clk_clk}]
create_clock -name {rx_mac_clk_clk} -period 5.02 -waveform { 0.000 2.51 } [get_ports {*rx_mac_clk_clk }]
