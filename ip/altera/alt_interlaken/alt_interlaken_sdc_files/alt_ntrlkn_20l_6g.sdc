...
if {[catch {get_port_info -is_input_port [get_ports -nowarn {*cal_blk_clk}]} errmsg ]} {
	...
	set_max_skew -from * -to [get_registers { *hsio_bank*2*rx_capture[?] *hsio_bank*2*rx_capture[1?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock } 
	set_max_skew -from * -to [get_registers { *hsio_bank*2*rx_capture[3?] *hsio_bank*2*rx_capture[2?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*2*rx_capture[5?] *hsio_bank*2*rx_capture[4?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*2*rx_capture[7?] *hsio_bank*2*rx_capture[6?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*2*rx_capture[9?] *hsio_bank*2*rx_capture[8?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }

	set_max_skew -from * -to [get_registers { *hsio_bank*3*rx_capture[?] *hsio_bank*3*rx_capture[1?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock } 
	set_max_skew -from * -to [get_registers { *hsio_bank*3*rx_capture[3?] *hsio_bank*3*rx_capture[2?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*3*rx_capture[5?] *hsio_bank*3*rx_capture[4?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*3*rx_capture[7?] *hsio_bank*3*rx_capture[6?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
	set_max_skew -from * -to [get_registers { *hsio_bank*3*rx_capture[9?] *hsio_bank*3*rx_capture[8?]}] 0.000 -exclude { clock_uncertainty from_clock to_clock }
