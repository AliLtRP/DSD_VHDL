...
module alt_ntrlkn_12l_10g_crc32c_dat64_only (d,crc_out);
input[63:0] d;
output[31:0] crc_out;
wire[31:0] crc_out;
...
generate
   if (METHOD == 0)
      alt_ntrlkn_12l_10g_crc32c_dat64_only_flat cc (.d(d),.crc_out(crc_out));
   else
      alt_ntrlkn_12l_10g_crc32c_dat64_only_factor cc (.d(d),.crc_out(crc_out));
endgenerate
endmodule
