...
module alt_ntrlkn_12l_10g_crc32c_z64x2 (c,crc_out);
input[31:0] c;
output[31:0] crc_out;
wire[31:0] crc_out;
...
generate
   if (METHOD == 0)
      alt_ntrlkn_12l_10g_crc32c_z64x2_flat cc (.c(c),.crc_out(crc_out));
   else
      alt_ntrlkn_12l_10g_crc32c_z64x2_factor cc (.c(c),.crc_out(crc_out));
endgenerate
endmodule
