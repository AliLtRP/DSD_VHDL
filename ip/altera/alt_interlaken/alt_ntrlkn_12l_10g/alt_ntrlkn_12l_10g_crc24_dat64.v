...
module alt_ntrlkn_12l_10g_crc24_dat64 (
	input[23:0] crc_in,
	input[63:0] dat_in,
	output[23:0] crc_out
);
...
generate
  if (METHOD == 0)
    alt_ntrlkn_12l_10g_crc24_dat64_flat cc (.c(crc_in),.d(dat_in),.crc_out(crc_out));
  else
    alt_ntrlkn_12l_10g_crc24_dat64_factor cc (.c(crc_in),.d(dat_in),.crc_out(crc_out));
endgenerate
