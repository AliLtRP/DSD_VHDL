...
SOF_NAME=SIV.sof
ELF_NAME=demo_control.elf

# SOPC_DIR is used for the sof file location as well
SOPC_SYSTEM_NAME=demo_control
SOPC_DIR=../synthesis
...
echo "Completed generating bsp"
#exit 1

# generate the application in the $APP_DIR
cmd="nios2-app-generate-makefile --app-dir $APP_DIR --bsp-dir $BSP_DIR --elf-name $ELF_NAME --src-dir $SRC_DIR"
$cmd || {
