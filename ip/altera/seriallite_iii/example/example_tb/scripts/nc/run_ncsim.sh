...
irun -compile -sv +define+SIMULATION +incdir+../../src+../ -F seriallite_src_lst_ncsim.txt

# Run the simulation

ncelab -access +w+r+c -defparam test_env.lanes=5 test_env
ncsim -run +random_seed=123456 +define+SIMULATION +test_name=data_forwarding test_env
