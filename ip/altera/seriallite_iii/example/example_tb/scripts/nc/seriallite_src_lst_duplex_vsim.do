...
#// Source Components 
vlog -sv +incdir+$env(SIM_LOCATION)/seriallite_iii/ $env(SIM_LOCATION)/seriallite_iii/seriallite_iii_streaming.v +access +w +define+ALTERA +define+SIMULATION 
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/source_clock_gen.v +access +w +define+ALTERA +define+SIMULATION
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/source_application.v +access +w +define+ALTERA +define+SIMULATION
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/dv_gen.v
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/reset_delay.v
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/source_adaptation.v +access +w +define+ALTERA +define+SIMULATION
vlog -sv $env(SIM_LOCATION)/seriallite_iii/*.v +access +w +define+ALTERA +define+SIMULATION
#vlog -sv $env(SIM_LOCATION)/seriallite_iii/clkctrl.v +access +w +define+ALTERA +define+SIMULATION
...
#// Sink Components
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/sink_clock_gen.v +access +w +define+ALTERA +define+SIMULATION
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/sink_application.v +access +w +define+ALTERA +define+SIMULATION
vlog -sv $env(SIM_LOCATION)/seriallite_iii/mentor/sink_adaptation.v +access +w +define+ALTERA +define+SIMULATION
...
vlog -sv +incdir+../../src+../ ../test_env.v +access +w +define+ALTERA +define+SIMULATION +define+DUPLEX_MODE
