...
vlog -sv -f interlaken_phy_ip_lib_src_lst.txt +access +w +define+ALTERA +define+SIMULATION +define+DUPLEX_MODE
vlog -sv -f reconfig_ctrlr_lib_src_lst.txt +access +w +define+ALTERA +define+SIMULATION +define+DUPLEX_MODE

# Compile the generic design files
vlog -sv +incdir+../../src+../ -f seriallite_src_lst_rivr.txt +access +w +define+ALTERA +define+SIMULATION +define+ADVANCED_CLOCKING +define+DUPLEX_MODE
