...
// ============================================================
// File Name: alt_c3gxb_reconfig_c4gxb.v
// Megafunction Name(s):
// 			alt_c3gxb_reconfig
//
...
module  alt_c3gxb_reconfig_c4gxb_alt_dprio_q9l
	( 
	address,
	busy,
	datain,
...
endmodule //alt_c3gxb_reconfig_c4gxb_alt_dprio_q9l
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_c3gxb_reconfig_c4gxb_mux_cda
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire  [2:0]  sel_node;
	wire  [7:0]  w_data1136w;
	wire  [3:0]  w_data1156w;
	wire  [3:0]  w_data1157w;
	wire  [7:0]  w_data1205w;
	wire  [3:0]  w_data1225w;
	wire  [3:0]  w_data1226w;
	wire  [7:0]  w_data1272w;
	wire  [3:0]  w_data1292w;
	wire  [3:0]  w_data1293w;
	wire  [7:0]  w_data1339w;
	wire  [3:0]  w_data1359w;
	wire  [3:0]  w_data1360w;
	wire  [7:0]  w_data1406w;
	wire  [3:0]  w_data1426w;
	wire  [3:0]  w_data1427w;
	wire  [7:0]  w_data1473w;
	wire  [3:0]  w_data1493w;
	wire  [3:0]  w_data1494w;
	wire  [1:0]  w_sel1158w;
	wire  [1:0]  w_sel1227w;
	wire  [1:0]  w_sel1294w;
	wire  [1:0]  w_sel1361w;
	...
	assign
		result = result_node,
		result_node = {((sel_node[2] & (((w_data1494w[1] & w_sel1495w[0]) & (~ (((w_data1494w[0] & (~ w_sel1495w[1])) & (~ w_sel1495w[0])) | (w_sel1495w[1] & (w_sel1495w[0] | w_data1494w[2]))))) | ((((w_data1494w[0] & (~ w_sel1495w[1])) & (~ w_sel1495w[0])) | (w_sel1495w[1] & (w_sel1495w[0] | w_data1494w[2]))) & (w_data1494w[3] | (~ w_sel1495w[0]))))) | ((~ sel_node[2]) & (((w_data1493w[1] & w_sel1495w[0]) & (~ (((w_data1493w[0] & (~ w_sel1495w[1])) & (~ w_sel1495w[0])) | (w_sel1495w[1] & (w_sel1495w[0] | w_data1493w[2]))))) | ((((w_data1493w[0] & (~ w_sel1495w[1])) & (~ w_sel1495w[0])) | (w_sel1495w[1] & (w_sel1495w[0] | w_data1493w[2]))) & (w_data1493w[3] | (~ w_sel1495w[0])))))), ((sel_node[2] & (((w_data1427w[1] & w_sel1428w[0]) & (~ (((w_data1427w[0] & (~ w_sel1428w[1])) & (~ w_sel1428w[0])) | (w_sel1428w[1] & (w_sel1428w[0] | w_data1427w[2]))))) | ((((w_data1427w[0] & (~ w_sel1428w[1])) & (~ w_sel1428w[0])) | (w_sel1428w[1] & (w_sel1428w[0] | w_data1427w[2]))) & (w_data1427w[3] | (~ w_sel1428w[0]))))) | ((~ sel_node[2]) & (((w_data1426w[1] & w_sel1428w[0]) & (~ (((w_data1426w[0] & (~ w_sel1428w[1])) & (~ w_sel1428w[0])) | (w_sel1428w[1] & (w_sel1428w[0] | w_data1426w[2]))))) | ((((w_data1426w[0] & (~ w_sel1428w[1])) & (~ w_sel1428w[0])) | (w_sel1428w[1] & (w_sel1428w[0] | w_data1426w[2]))) & (w_data1426w[3] | (~ w_sel1428w[0])))))), ((sel_node[2] & (((w_data1360w[1] & w_sel1361w[0]) & (~ (((w_data1360w[0] & (~ w_sel1361w[1])) & (~ w_sel1361w[0])) | (w_sel1361w[1] & (w_sel1361w[0] | w_data1360w[2]))))) | ((((w_data1360w[0] & (~ w_sel1361w[1])) & (~ w_sel1361w[0])) | (w_sel1361w[1] & (w_sel1361w[0] | w_data1360w[2]))) & (w_data1360w[3] | (~ w_sel1361w[0]))))) | ((~ sel_node[2]) & (((w_data1359w[1] & w_sel1361w[0]) & (~ (((w_data1359w[0] & (~ w_sel1361w[1])) & (~ w_sel1361w[0])) | (w_sel1361w[1] & (w_sel1361w[0] | w_data1359w[2]))))) | ((((w_data1359w[0] & (~ w_sel1361w[1])) & (~ w_sel1361w[0])) | (w_sel1361w[1] & (w_sel1361w[0] | w_data1359w[2]))) & (w_data1359w[3] | (~ w_sel1361w[0])))))), ((sel_node[2] & (((w_data1293w[1]
 & w_sel1294w[0]) & (~ (((w_data1293w[0] & (~ w_sel1294w[1])) & (~ w_sel1294w[0])) | (w_sel1294w[1] & (w_sel1294w[0] | w_data1293w[2]))))) | ((((w_data1293w[0] & (~ w_sel1294w[1])) & (~ w_sel1294w[0])) | (w_sel1294w[1] & (w_sel1294w[0] | w_data1293w[2]))) & (w_data1293w[3] | (~ w_sel1294w[0]))))) | ((~ sel_node[2]) & (((w_data1292w[1] & w_sel1294w[0]) & (~ (((w_data1292w[0] & (~ w_sel1294w[1])) & (~ w_sel1294w[0])) | (w_sel1294w[1] & (w_sel1294w[0] | w_data1292w[2]))))) | ((((w_data1292w[0] & (~ w_sel1294w[1])) & (~ w_sel1294w[0])) | (w_sel1294w[1] & (w_sel1294w[0] | w_data1292w[2]))) & (w_data1292w[3] | (~ w_sel1294w[0])))))), ((sel_node[2] & (((w_data1226w[1] & w_sel1227w[0]) & (~ (((w_data1226w[0] & (~ w_sel1227w[1])) & (~ w_sel1227w[0])) | (w_sel1227w[1] & (w_sel1227w[0] | w_data1226w[2]))))) | ((((w_data1226w[0] & (~ w_sel1227w[1])) & (~ w_sel1227w[0])) | (w_sel1227w[1] & (w_sel1227w[0] | w_data1226w[2]))) & (w_data1226w[3] | (~ w_sel1227w[0]))))) | ((~ sel_node[2]) & (((w_data1225w[1] & w_sel1227w[0]) & (~ (((w_data1225w[0] & (~ w_sel1227w[1])) & (~ w_sel1227w[0])) | (w_sel1227w[1] & (w_sel1227w[0] | w_data1225w[2]))))) | ((((w_data1225w[0] & (~ w_sel1227w[1])) & (~ w_sel1227w[0])) | (w_sel1227w[1] & (w_sel1227w[0] | w_data1225w[2]))) & (w_data1225w[3] | (~ w_sel1227w[0])))))), ((sel_node[2] & (((w_data1157w[1] & w_sel1158w[0]) & (~ (((w_data1157w[0] & (~ w_sel1158w[1])) & (~ w_sel1158w[0])) | (w_sel1158w[1] & (w_sel1158w[0] | w_data1157w[2]))))) | ((((w_data1157w[0] & (~ w_sel1158w[1])) & (~ w_sel1158w[0])) | (w_sel1158w[1] & (w_sel1158w[0] | w_data1157w[2]))) & (w_data1157w[3] | (~ w_sel1158w[0]))))) | ((~ sel_node[2]) & (((w_data1156w[1] & w_sel1158w[0]) & (~ (((w_data1156w[0] & (~ w_sel1158w[1])) & (~ w_sel1158w[0])) | (w_sel1158w[1] & (w_sel1158w[0] | w_data1156w[2]))))) | ((((w_data1156w[0] & (~ w_sel1158w[1])) & (~ w_sel1158w[0])) | (w_sel1158w[1] & (w_sel1158w[0] | w_data1156w[2]))) & (w_data1156w[3] | (~ w_sel1158w[0]))))))},
		sel_ffs_wire = {sel[2:0]},
		sel_node = {sel_ffs_wire[2], sel[1:0]},
		w_data1136w = {{2{1'b0}}, data[30], data[24], data[18], data[12], data[6], data[0]},
		w_data1156w = w_data1136w[3:0],
		w_data1157w = w_data1136w[7:4],
		w_data1205w = {{2{1'b0}}, data[31], data[25], data[19], data[13], data[7], data[1]},
		w_data1225w = w_data1205w[3:0],
		w_data1226w = w_data1205w[7:4],
		w_data1272w = {{2{1'b0}}, data[32], data[26], data[20], data[14], data[8], data[2]},
		w_data1292w = w_data1272w[3:0],
		w_data1293w = w_data1272w[7:4],
		w_data1339w = {{2{1'b0}}, data[33], data[27], data[21], data[15], data[9], data[3]},
		w_data1359w = w_data1339w[3:0],
		w_data1360w = w_data1339w[7:4],
		w_data1406w = {{2{1'b0}}, data[34], data[28], data[22], data[16], data[10], data[4]},
		w_data1426w = w_data1406w[3:0],
		w_data1427w = w_data1406w[7:4],
		w_data1473w = {{2{1'b0}}, data[35], data[29], data[23], data[17], data[11], data[5]},
		w_data1493w = w_data1473w[3:0],
		w_data1494w = w_data1473w[7:4],
		w_sel1158w = sel_node[1:0],
		w_sel1227w = sel_node[1:0],
		w_sel1294w = sel_node[1:0],
		w_sel1361w = sel_node[1:0],
		w_sel1428w = sel_node[1:0],
		w_sel1495w = sel_node[1:0];
endmodule //alt_c3gxb_reconfig_c4gxb_mux_cda
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_c3gxb_reconfig_c4gxb_mux_4da
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire  [1:0]  sel_node;
	wire  [3:0]  w_data1543w;

	assign
		result = result_node,
		result_node = {(((w_data1543w[1] & sel_node[0]) & (~ (((w_data1543w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1543w[2]))))) | ((((w_data1543w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1543w[2]))) & (w_data1543w[3] | (~ sel_node[0]))))},
		sel_node = {sel[1:0]},
		w_data1543w = {data[3:0]};
endmodule //alt_c3gxb_reconfig_c4gxb_mux_4da
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_c3gxb_reconfig_c4gxb_mux_8da
	( 
	data,
	result,
	sel) ;
...
`endif
	...
	wire  [1:0]  sel_node;
	wire  [3:0]  w_data1579w;
	wire  [3:0]  w_data1609w;
	wire  [3:0]  w_data1634w;
	wire  [3:0]  w_data1659w;
	wire  [3:0]  w_data1684w;

	assign
		result = result_node,
		result_node = {(((w_data1684w[1] & sel_node[0]) & (~ (((w_data1684w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1684w[2]))))) | ((((w_data1684w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1684w[2]))) & (w_data1684w[3] | (~ sel_node[0])))), (((w_data1659w[1] & sel_node[0]) & (~ (((w_data1659w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1659w[2]))))) | ((((w_data1659w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1659w[2]))) & (w_data1659w[3] | (~ sel_node[0])))), (((w_data1634w[1] & sel_node[0]) & (~ (((w_data1634w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1634w[2]))))) | ((((w_data1634w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1634w[2]))) & (w_data1634w[3] | (~ sel_node[0])))), (((w_data1609w[1] & sel_node[0]) & (~ (((w_data1609w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1609w[2]))))) | ((((w_data1609w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1609w[2]))) & (w_data1609w[3] | (~ sel_node[0])))), (((w_data1579w[1] & sel_node[0]) & (~ (((w_data1579w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1579w[2]))))) | ((((w_data1579w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data1579w[2]))) & (w_data1579w[3] | (~ sel_node[0]))))},
		sel_node = {sel[1:0]},
		w_data1579w = {data[15], data[10], data[5], data[0]},
		w_data1609w = {data[16], data[11], data[6], data[1]},
		w_data1634w = {data[17], data[12], data[7], data[2]},
		w_data1659w = {data[18], data[13], data[8], data[3]},
		w_data1684w = {data[19], data[14], data[9], data[4]};
endmodule //alt_c3gxb_reconfig_c4gxb_mux_8da
...
module  alt_c3gxb_reconfig_c4gxb_alt_c3gxb_reconfig_koh1
	( 
	busy,
...
`endif
	...
	alt_c3gxb_reconfig_c4gxb_alt_dprio_q9l   dprio
	( 
	...
	alt_c3gxb_reconfig_c4gxb_mux_cda   central_pcs_first_word_mux
	( 
	...
	assign
		...
		table_43_data = {dprio_dataout_reg[15:3], (({3{(~ write_skip)}} & reconfig_data_reg[2:0]) | ({3{write_skip}} & dprio_dataout_reg[2:0]))},
...
endmodule //alt_c3gxb_reconfig_c4gxb_alt_c3gxb_reconfig_koh1
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module alt_c3gxb_reconfig_c4gxb (
	logical_channel_address,
	reconfig_clk,
	reconfig_data,
	reconfig_fromgxb,
	...
	alt_c3gxb_reconfig_c4gxb_alt_c3gxb_reconfig_koh1	alt_c3gxb_reconfig_c4gxb_alt_c3gxb_reconfig_koh1_component (
	 ...
	 clearbox_defparam = "base_port_width=1;cbx_blackbox_list=-lpm_mux;channel_address_width=4;enable_chl_addr_for_analog_ctrl=TRUE;intended_device_family=Cyclone IV GX;mif_address_width=6;number_of_channels=16;number_of_reconfig_ports=4;read_base_port_width=1;enable_buf_cal=true;reconfig_fromgxb_width=20;reconfig_togxb_width=4;" */;
...
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL alt_c3gxb_reconfig_c4gxb_bb.v FALSE
