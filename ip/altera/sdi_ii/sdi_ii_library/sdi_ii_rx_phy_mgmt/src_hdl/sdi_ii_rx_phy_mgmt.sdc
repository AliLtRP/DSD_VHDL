...
# Set False Path
#**************************************************************
set_false_path -from [get_keepers {*u_xcvr_ctrl_*|t_rst_sdi}] -to [get_keepers {*u_xcvr_ctrl_*|t_rst_sdi_sync*}]
set_false_path -from [get_keepers {*u_xcvr_ctrl_*|t_rst_sdi_sync_out}]
