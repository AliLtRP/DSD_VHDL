...
set megacore_lib_dir "\altera\81\ip\reed_solomon\lib"
set design_name "rs"
set rs_arch "DEC"
...
lappend vsim_cmd "$timing_resolution"
	...
	#add wave sim:/testbench/test_controller/numcheck
	#add wave sim:/testbench/test_controller/num_err_sym
	#add wave sim:/testbench/test_controller/bypass
	#add wave sim:/testbench/test_controller/decfail
	
	#add wave sim:/testbench/test_controller/Bench_2_dec_erasures
	#add wave sim:/testbench/test_controller/num_err_bit
	#add wave sim:/testbench/test_controller/num_err_bit0
	#add wave sim:/testbench/test_controller/num_err_bit1
	#add wave sim:/testbench/test_controller/rserr
	#add wave sim:/testbench/test_controller/numn
