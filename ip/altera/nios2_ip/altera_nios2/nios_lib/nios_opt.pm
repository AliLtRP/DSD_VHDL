...
get_default_nios_infos
{
    my $nios_infos = {
      ...
      dcache_info => {
        ...
        cache_dcache_victim_buf_impl      => "ram", # ram or reg
      },
      divide_info => {
...
elaborate_nios_infos
{
    ...
    my $interrupt_info = manditory_hash($nios_infos, "interrupt_info");
