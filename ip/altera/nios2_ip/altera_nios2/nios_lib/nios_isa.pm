...
convert_to_c
{
    ...
    push(@$h_lines, "");
    push(@$h_lines, "#ifndef _NIOS_ISA_CONSTANTS_");
    push(@$h_lines, "#define _NIOS_ISA_CONSTANTS_");
    ...
    format_hash_as_c_macros(\%constants, $h_lines) || return undef;

    push(@$h_lines, "#endif /* _NIOS_ISA_CONSTANTS_ */");
