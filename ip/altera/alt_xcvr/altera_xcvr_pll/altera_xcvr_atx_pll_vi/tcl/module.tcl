...
package provide altera_xcvr_atx_pll_vi::module 13.1
...
namespace eval ::altera_xcvr_atx_pll_vi::module:: {
   ...
   variable module {\
      ...
      {altera_xcvr_atx_pll_a10  13.1  {"Arria VI" "Arria10"}              true      false       false     ::altera_xcvr_atx_pll_vi::module::elaborate  "Arria 10 Transceiver ATX PLL"    "PLL"            "Altera Corporation"  NOVAL       "http://www.altera.com/literature/ug/xcvr_user_guide.pdf"   "Arria 10 Transceiver ATX PLL." }\
   }
}             
