...
# -----------------------
#   [ cpu ]  <---->  [ half_rate_bridge_0 ] <-----> [ ddr2_sdram ]
#
# Variable :
# ----------
...
#   and add the lien below at the end of the Quartus Setting File
#
...
#
#-----------------------------------------------------------------------------------------------
set slow_clk    "replace_text_here_with_a_path_of_a_clock"
set instance    "replace_text_here_with_the_instance_name_of_Avalon_MM_DDR_Memory_Half_Rate_Bridge"
