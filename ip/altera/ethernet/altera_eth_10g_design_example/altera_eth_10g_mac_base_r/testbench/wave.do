...
add wave -noupdate -radix hexadecimal -radixenum numeric /tb/reset
...
add wave -noupdate /tb/rx_data_ready
add wave -noupdate /tb/rx_pma_ready
add wave -noupdate /tb/tx_pma_ready
...
add wave -noupdate -radix hexadecimal -radixenum numeric /tb/base_r_rx_data
add wave -noupdate -divider {BASE-R TX}
add wave -noupdate -radix hexadecimal -radixenum numeric /tb/base_r_tx_data
