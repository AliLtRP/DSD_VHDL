...
// ============================================================
// File Name: altera_tse_alt4gxb_gige_16b.v
// Megafunction Name(s):
// 			alt4gxb
//
...
//
// 12.1 Build 176 10/31/2012 SJ Full Version
// ************************************************************
...
//alt4gxb CBX_AUTO_BLACKBOX="ALL" device_family="Stratix IV" effective_data_rate="3125.0 Mbps" enable_lc_tx_pll="false" equalizer_ctrl_a_setting=0 equalizer_ctrl_b_setting=0 equalizer_ctrl_c_setting=0 equalizer_ctrl_d_setting=0 equalizer_ctrl_v_setting=0 equalizer_dcgain_setting=0 gen_reconfig_pll="false" gx_channel_type="auto" gxb_analog_power="AUTO" gxb_powerdown_width=1 input_clock_frequency="125.0 MHz" intended_device_speed_grade="4" intended_device_variant="GX" loopback_mode="slb" number_of_channels=1 number_of_quads=1 operation_mode="duplex" pll_control_width=1 pll_pfd_fb_mode="internal" preemphasis_ctrl_1stposttap_setting=0 preemphasis_ctrl_2ndposttap_inv_setting="false" preemphasis_ctrl_2ndposttap_setting=0 preemphasis_ctrl_pretap_inv_setting="false" preemphasis_ctrl_pretap_setting=0 protocol="gige" receiver_termination="OCT_100_OHMS" reconfig_calibration="true" reconfig_dprio_mode=1 reconfig_fromgxb_port_width=17 reconfig_togxb_port_width=4 rx_8b_10b_mode="normal" rx_align_pattern="0101111100" rx_align_pattern_length=10 rx_allow_align_polarity_inversion="false" rx_allow_pipe_polarity_inversion="false" rx_bitslip_enable="false" rx_byte_ordering_mode="none" rx_channel_width=16 rx_common_mode="0.82v" rx_cru_bandwidth_type="medium" rx_cru_inclock0_period=8000 rx_cru_m_divider=25 rx_cru_n_divider=2 rx_cru_vco_post_scale_divider=2 rx_data_rate=3125 rx_data_rate_remainder=0 rx_datapath_protocol="basic" rx_digitalreset_port_width=1 rx_dwidth_factor=2 rx_enable_bit_reversal="false" rx_enable_lock_to_data_sig="false" rx_enable_lock_to_refclk_sig="false" rx_enable_self_test_mode="false" rx_force_signal_detect="true" rx_ppmselect=32 rx_rate_match_fifo_mode="normal" rx_rate_match_fifo_mode_manual_control="normal" rx_rate_match_pattern1="10100010010101111100" rx_rate_match_pattern2="10101011011010000011" rx_rate_match_pattern_size=20 rx_run_length=5 rx_run_length_enable="true" rx_signal_detect_loss_threshold=1 rx_signal_detect_threshold=2 rx_signal_detect_valid_threshold=1 rx_use_align_state_machine="true" rx_use_clkout="true" rx_use_coreclk="false" rx_use_cruclk="true" rx_use_deserializer_double_data_mode="false" rx_use_deskew_fifo="false" rx_use_double_data_mode="true" rx_use_external_termination="false" rx_use_rate_match_pattern1_only="false" rx_word_aligner_num_byte=1 starting_channel_number=0 transmitter_termination="OCT_100_OHMS" tx_8b_10b_mode="normal" tx_allow_polarity_inversion="false" tx_analog_power="auto" tx_channel_width=16 tx_clkout_width=1 tx_common_mode="0.65v" tx_data_rate=3125 tx_data_rate_remainder=0 tx_digitalreset_port_width=1 tx_dwidth_factor=2 tx_enable_bit_reversal="false" tx_enable_self_test_mode="false" tx_pll_bandwidth_type="high" tx_pll_clock_post_divider=1 tx_pll_inclk0_period=8000 tx_pll_m_divider=25 tx_pll_n_divider=2 tx_pll_type="CMU" tx_pll_vco_post_scale_divider=2 tx_slew_rate="medium" tx_transmit_protocol="basic" tx_use_coreclk="false" tx_use_double_data_mode="true" tx_use_external_termination="false" tx_use_serializer_double_data_mode="false" use_calibration_block="true" vod_ctrl_setting=1 cal_blk_clk fixedclk fixedclk_fast gxb_powerdown pll_inclk pll_locked pll_powerdown reconfig_clk reconfig_fromgxb reconfig_togxb rx_analogreset rx_clkout rx_cruclk rx_ctrldetect rx_datain rx_dataout rx_digitalreset rx_disperr rx_errdetect rx_freqlocked rx_patterndetect rx_recovclkout rx_rlv rx_rmfifodatadeleted rx_rmfifodatainserted rx_runningdisp rx_seriallpbken rx_syncstatus tx_clkout tx_ctrlenable tx_datain tx_dataout tx_digitalreset
//VERSION_BEGIN 12.1 cbx_alt4gxb 2012:10:31:18:03:02:SJ cbx_mgl 2012:10:31:18:48:06:SJ cbx_tgx 2012:10:31:18:03:02:SJ  VERSION_END
...
module  altera_tse_alt4gxb_gige_16b_alt4gxb_deba
	( 
	cal_blk_clk,
	fixedclk,
	fixedclk_fast,
...
`endif
	...
	defparam
		...
		ch_clk_div0.effective_data_rate = "3125.0 Mbps",
	...
	defparam
		...
		rx_cdr_pll0.effective_data_rate = "3125.0 Mbps",
	...
	assign
		...
		rx_rmfifodatadeleted = {wire_receive_pcs0_rmfifodatadeleted[1:0]},
		rx_rmfifodatainserted = {wire_receive_pcs0_rmfifodatainserted[1:0]},
		rx_rmfiforeset = 1'b0,
		rx_runningdisp = {wire_receive_pcs0_runningdisp[1:0]},
...
endmodule //altera_tse_alt4gxb_gige_16b_alt4gxb_deba
//VALID FILE
...
`timescale 1 ps / 1 ps
// synopsys translate_on
module altera_tse_alt4gxb_gige_16b (
	cal_blk_clk,
	fixedclk,
	fixedclk_fast,
	gxb_powerdown,
...
`endif
	...
	wire [1:0] rx_disperr = sub_wire4[1:0];
	wire [0:0] rx_recovclkout = sub_wire5[0:0];
	wire [1:0] rx_runningdisp = sub_wire6[1:0];
	wire [1:0] rx_syncstatus = sub_wire7[1:0];
	wire  rx_clkout = sub_wire8;
	wire [15:0] rx_dataout = sub_wire9[15:0];
	wire [1:0] rx_errdetect = sub_wire10[1:0];
	wire [1:0] rx_rmfifodatainserted = sub_wire11[1:0];
	wire [0:0] rx_rlv = sub_wire12[0:0];
	wire [1:0] rx_rmfifodatadeleted = sub_wire13[1:0];
	wire [0:0] tx_clkout = sub_wire14[0:0];
	wire [0:0] tx_dataout = sub_wire15[0:0];
	wire [1:0] rx_ctrldetect = sub_wire16[1:0];

	altera_tse_alt4gxb_gige_16b_alt4gxb_deba	altera_tse_alt4gxb_gige_16b_alt4gxb_deba_component (
	 ...
	 clearbox_defparam = "effective_data_rate=3125.0 Mbps;enable_lc_tx_pll=false;equalizer_ctrl_a_setting=0;equalizer_ctrl_b_setting=0;equalizer_ctrl_c_setting=0;equalizer_ctrl_d_setting=0;equalizer_ctrl_v_setting=0;equalizer_dcgain_setting=0;gen_reconfig_pll=false;gxb_analog_power=AUTO;gx_channel_type=AUTO;input_clock_frequency=125.0 MHz;intended_device_family=Stratix IV;intended_device_speed_grade=4;intended_device_variant=GX;loopback_mode=slb;lpm_type=alt4gxb;number_of_channels=1;operation_mode=duplex;pll_control_width=1;pll_pfd_fb_mode=internal;preemphasis_ctrl_1stposttap_setting=0;preemphasis_ctrl_2ndposttap_inv_setting=false;preemphasis_ctrl_2ndposttap_setting=0;preemphasis_ctrl_pretap_inv_setting=false;preemphasis_ctrl_pretap_setting=0;protocol=gige;receiver_termination=oct_100_ohms;reconfig_dprio_mode=1;rx_8b_10b_mode=normal;rx_align_pattern=0101111100;rx_align_pattern_length=10;rx_allow_align_polarity_inversion=false;rx_allow_pipe_polarity_inversion=false;rx_bitslip_enable=false;rx_byte_ordering_mode=NONE;rx_channel_width=16;rx_common_mode=0.82v;rx_cru_bandwidth_type=Medium;rx_cru_inclock0_period=8000;rx_datapath_protocol=basic;rx_data_rate=3125;rx_data_rate_remainder=0;rx_digitalreset_port_width=1;rx_enable_bit_reversal=false;rx_enable_lock_to_data_sig=false;rx_enable_lock_to_refclk_sig=false;rx_enable_self_test_mode=false;rx_force_signal_detect=true;rx_ppmselect=32;rx_rate_match_fifo_mode=normal;rx_rate_match_fifo_mode_manual_control=normal;rx_rate_match_pattern1=10100010010101111100;
	                      rx_rate_match_pattern2=10101011011010000011;rx_rate_match_pattern_size=20;rx_run_length=5;rx_run_length_enable=true;rx_signal_detect_threshold=2;rx_use_align_state_machine=true;rx_use_clkout=true;rx_use_coreclk=false;rx_use_cruclk=true;rx_use_deserializer_double_data_mode=false;rx_use_deskew_fifo=false;rx_use_double_data_mode=true;rx_use_rate_match_pattern1_only=false;transmitter_termination=oct_100_ohms;tx_8b_10b_mode=normal;tx_allow_polarity_inversion=false;tx_analog_power=AUTO;tx_channel_width=16;tx_clkout_width=1;tx_common_mode=0.65v;tx_data_rate=3125;tx_data_rate_remainder=0;tx_digitalreset_port_width=1;tx_enable_bit_reversal=false;tx_enable_self_test_mode=false;tx_pll_bandwidth_type=High;tx_pll_inclk0_period=8000;tx_pll_type=CMU;tx_slew_rate=medium;tx_transmit_protocol=basic;tx_use_coreclk=false;tx_use_double_data_mode=true;tx_use_serializer_double_data_mode=false;use_calibration_block=true;vod_ctrl_setting=1;gxb_powerdown_width=1;number_of_quads=1;reconfig_calibration=true;reconfig_fromgxb_port_width=17;reconfig_togxb_port_width=4;rx_cru_m_divider=25;rx_cru_n_divider=2;rx_cru_vco_post_scale_divider=2;rx_dwidth_factor=2;rx_signal_detect_loss_threshold=1;rx_signal_detect_valid_threshold=1;rx_use_external_termination=false;rx_word_aligner_num_byte=1;tx_dwidth_factor=2;tx_pll_clock_post_divider=1;tx_pll_m_divider=25;tx_pll_n_divider=2;tx_pll_vco_post_scale_divider=2;tx_use_external_termination=false;" */;
	defparam
		altera_tse_alt4gxb_gige_16b_alt4gxb_deba_component.starting_channel_number = starting_channel_number;
...
// Retrieval info: PRIVATE: WIZ_DATA_RATE STRING "3125.0"
// Retrieval info: PRIVATE: WIZ_DPRIO_INCLK_FREQ_ARRAY STRING "125.0 156.25"
...
// Retrieval info: PRIVATE: WIZ_INCLK_FREQ_ARRAY STRING "125.0 156.25"
// Retrieval info: PRIVATE: WIZ_INPUT_A STRING "3125.0"
...
// Retrieval info: CONSTANT: EFFECTIVE_DATA_RATE STRING "3125.0 Mbps"
...
// Retrieval info: USED_PORT: rx_rmfifodatadeleted 0 0 2 0 OUTPUT NODEFVAL "rx_rmfifodatadeleted[1..0]"
// Retrieval info: USED_PORT: rx_rmfifodatainserted 0 0 2 0 OUTPUT NODEFVAL "rx_rmfifodatainserted[1..0]"
...
// Retrieval info: CONNECT: rx_rmfifodatadeleted 0 0 2 0 @rx_rmfifodatadeleted 0 0 2 0
// Retrieval info: CONNECT: rx_rmfifodatainserted 0 0 2 0 @rx_rmfifodatainserted 0 0 2 0
...
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b.v TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b.ppf TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b.inc FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b.cmp FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b.bsf FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b_inst.v FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL altera_tse_alt4gxb_gige_16b_bb.v TRUE
