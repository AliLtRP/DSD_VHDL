...
attribute altera_attribute of SYN: ARCHITECTURE is "suppress_da_rule_internal=z100";
	...
	GENERIC (
		...
		REVISION_ID	: STD_LOGIC_VECTOR := X"23";
...
-- Retrieval info:      <PRIVATE name = "REVISION" value="0x23"  type="STRING"  enable="1" />
...
-- Retrieval info:     <CONSTANT name = "REVISION_ID" value="23"  type="HDL_VECTOR"  radix="HEX"  width="8"  vhdl_type="STD_LOGIC_VECTOR" />
