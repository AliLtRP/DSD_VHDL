...
module pci_top (
	...
	defparam
		pci_t64_inst.CLASS_CODE = 24'hff0000,
		pci_t64_inst.DEVICE_ID = 16'h0004,
		pci_t64_inst.REVISION_ID = 8'h01,
		pci_t64_inst.SUBSYSTEM_ID = 16'h0000,
		pci_t64_inst.SUBSYSTEM_VENDOR_ID = 16'h0000,
		pci_t64_inst.TARGET_DEVICE = "NEW",
		pci_t64_inst.VENDOR_ID = 16'h1172,
		pci_t64_inst.MIN_GRANT = 8'h00,
		pci_t64_inst.MAX_LATENCY = 8'h00,
		pci_t64_inst.CAP_PTR = 8'h40,
		pci_t64_inst.CIS_PTR = 32'h00000001,
		pci_t64_inst.BAR0 = 32'hf0000000,
		pci_t64_inst.BAR1 = 32'hffffffc1,
		pci_t64_inst.BAR2 = 32'hff000000,
		pci_t64_inst.BAR3 = 32'hfff00000,
		pci_t64_inst.BAR4 = 32'hffff0000,
		pci_t64_inst.BAR5 = 32'hfffff000,
		pci_t64_inst.NUMBER_OF_BARS = 32'h00000006,
		pci_t64_inst.MAX_64_BAR_RW_BITS = 32'h00000008,
		pci_t64_inst.HARDWIRE_BAR0 = 32'h00000000,
		pci_t64_inst.HARDWIRE_BAR1 = 32'h00000000,
		pci_t64_inst.HARDWIRE_BAR2 = 32'h00000000,
		pci_t64_inst.HARDWIRE_BAR3 = 32'h00000000,
		pci_t64_inst.HARDWIRE_BAR4 = 32'h00000000,
		pci_t64_inst.HARDWIRE_BAR5 = 32'h00000000,
		pci_t64_inst.HARDWIRE_EXP_ROM = 32'h00000001,
		pci_t64_inst.EXP_ROM_BAR = 32'hfff00000,
		pci_t64_inst.PCI_66MHZ_CAPABLE = "YES",
		pci_t64_inst.INTERRUPT_PIN_REG = 8'h01,
		pci_t64_inst.ENABLE_BITS = 32'h00000180;
endmodule
...
// Retrieval info:      <PRIVATE name = "CIS_POINTER" value="0x00000001"  type="STRING"  enable="1" />
...
// Retrieval info:     <CONSTANT name = "CIS_PTR" value="00000001"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
