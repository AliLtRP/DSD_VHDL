...
module pci_top (
	...
	defparam
		...
		pci_mt64_inst.BAR0 = 32'hf0000000,
		pci_mt64_inst.BAR1 = 32'hffffffc1,
		pci_mt64_inst.BAR2 = 32'hff000000,
		pci_mt64_inst.BAR3 = 32'hfff00000,
		pci_mt64_inst.BAR4 = 32'hffff0000,
		pci_mt64_inst.BAR5 = 32'hfffff000,
		pci_mt64_inst.NUMBER_OF_BARS = 32'h00000006,
		...
		pci_mt64_inst.ENABLE_BITS = 32'h00000580;
endmodule
...
// Retrieval info:      <PRIVATE name = "INTERRUPT" value="1"  type="BOOLEAN"  enable="1" />
...
// Retrieval info:     <CONSTANT name = "ENABLE_BITS" value="00000580"  type="HDL_VECTOR"  radix="HEX"  width="32"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:    </CONSTANTS>
