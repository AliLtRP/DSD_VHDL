...
module pci_top /* synthesis altera_attribute="suppress_da_rule_internal=z100" */ (
	...
	defparam
		...
		pci_t64_inst.CIS_PTR = 32'h00000000,
		pci_t64_inst.BAR0 = 32'hfffffc00,
		pci_t64_inst.BAR1 = 32'hfffffff1,
		pci_t64_inst.BAR2 = 32'hfffffc00,
		pci_t64_inst.BAR3 = 32'hfff00000,
		pci_t64_inst.BAR4 = 32'hfff00000,
		pci_t64_inst.BAR5 = 32'hfff00000,
		pci_t64_inst.NUMBER_OF_BARS = 32'h00000003,
		...
		pci_t64_inst.ENABLE_BITS = 32'h00000000;
endmodule
