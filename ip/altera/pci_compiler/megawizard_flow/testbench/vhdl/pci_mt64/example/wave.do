...
add wave -noupdate -format Logic /altera_tb/par64
...
add wave -noupdate -format Logic /altera_tb/req64n
add wave -noupdate -format Logic /altera_tb/framen
add wave -noupdate -format Logic /altera_tb/irdyn
add wave -noupdate -format Logic /altera_tb/ack64n
...
add wave -noupdate -format Logic /altera_tb/l_ldat_ackn
add wave -noupdate -format Logic /altera_tb/l_hdat_ackn
...
add wave -noupdate -color Yellow -format Logic -itemcolor Yellow /altera_tb/lm_req64n
...
WaveRestoreCursors {{Cursor 1} {19704 ns} 0}
WaveRestoreZoom {19342 ns} {20014 ns}
