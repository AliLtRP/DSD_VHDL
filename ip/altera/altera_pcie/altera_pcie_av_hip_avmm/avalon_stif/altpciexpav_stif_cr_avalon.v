...
module altpciexpav_stif_cr_avalon
  (
   ...
   reg [CRA_RP_SEL:CRA_NONE_SEL] addr_decode_reg ;    
   ...
   function [CRA_RP_SEL:CRA_NONE_SEL] address_decode ;
        ...
        if (CraRstn_i == 1'b0)
          ...
          case (avalon_state_reg)
            ...
            CRA_PIPE :
                      ...
                      else if(CraWrite_i == 1'b1 & RpTxFifoFull_i == 1'b0)
